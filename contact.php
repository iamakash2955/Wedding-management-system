                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    <td>DelightWeddings</td>
                                    <td><i class="mdi mdi-deskphone mr-3"></i> 0612-123567876</td>
                                </tr>
                                <tr>
                                    <td>Harohalli, Bangalore</td>
                                    <td><i class="mdi mdi-phone mr-3"></i> +91 7022482002</td>
                                </tr>
                                <tr>
                                    <td>Karnataka 560069</td>
